  ...
  return (
    <>
      ...
      <article className="min-h-screen">
        {/* Header */}
        <header className="relative px-4 py-12 border-b border-dark-border">
          ...
          <div className="mx-auto max-w-5xl">
            ...
            {/* Title */}
            <h1
              className={`mb-4 pb-1 bg-gradient-to-r bg-clip-text text-3xl md:text-5xl font-bold text-transparent leading-normal ${meta.color}`}
            >
              {lesson.title}
            </h1>
          </div>
        ...
        {/* Prev / Next */}
        <footer className="px-4 py-10 border-t border-dark-border">
          <div className="mx-auto max-w-5xl flex items-stretch justify-between gap-4">
            {/* Prev */}
            {prev ? (
              <Link
